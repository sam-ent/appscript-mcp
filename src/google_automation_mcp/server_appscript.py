"""
Apps Script Tool Registrations

Registers Apps Script project, deployment, version, process, and metrics tools
with the MCP server.
"""
...
def register_appscript_tools(mcp):
    """Register Apps Script tools with the MCP server."""
